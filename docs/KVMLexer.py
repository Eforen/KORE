# This is the placeholder lexer (Just a copy of the Kerboscript Lexer)
...
class KVMLexer(RegexLexer):
   
    name = 'Kerbo Virtual Mechine Code'
    short_name = 'kVM'
    aliases = ['kerbovm', 'kvm', 'vm', 'vmcode']
    filenames = ['*.kvm']
