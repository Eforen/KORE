namespace Kore.RiscMeta {
    ...
    /// <summary>
    /// Extension methods for the Register enum to make encoding easier and type-safe.
    /// </summary>
    public static class RegisterExtensions
    {
        /// <summary>
        /// Converts a Register enum value to its numeric register number (0-31).
        /// </summary>
        public static uint AsUint(this Register reg)
        {
